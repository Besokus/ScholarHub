...
-- 种子数据
insert into "ResourceCategory"(code,name,sort) values ('课件','课件',0),
                                                      ('笔记','笔记',1),
                                                      ('真题','真题',2),
                                                      ('作业','作业',3),
                                                      ('答案','答案',4),
...
insert into "CourseCategory"(id,name,"createdAt")values(1,'计算机与信息技术类','2025-12-24 06:31:27.567'),
                                                       (2,'电子信息与通信类','2025-12-24 06:31:27.567'),
                                                       (3,'数学与统计类','2025-12-24 06:31:27.567'),
                                                       (4,'自动化与控制工程类','2025-12-24 06:31:27.567'),
                                                       (5,'机械与工程技术类','2025-12-24 06:31:27.567'),
                                                       (6,'电气与能源类','2025-12-24 06:31:27.567'),
                                                       (7,'经济管理与商科类','2025-12-24 06:31:27.567'),
                                                       (8,'人文社科与通识教育类','2025-12-24 06:31:27.567'),
                                                       (9,'外语与语言类','2025-12-24 06:31:27.567'),
                                                       (10,'艺术与设计类','2025-12-24 06:31:27.567'),
                                                       (11,'体育与健康类','2025-12-24 06:31:27.567'),
                                                       (12,'创新创业与实践类','2025-12-24 06:31:27.567');

insert into "Category"(id,name,code,"sortOrder")values(1,'基础课','basic',0),
                                                      (2,'专业课','major',0),
                                                      (3,'体育课','sport',0),
                                                      (4,'通识课','general',0);
